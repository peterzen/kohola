					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<span className="text-muted">({txInfo.estimatedSignedSize} bytes)</span>
							</td>
						</tr>
						<tr>
							<th scope="row">
								...
								<Table borderless className="m-0" size="sm">
									<tbody>
										{txInfo.decodedTx.getInputsList().map((i) => (
											<tr key={i.getPreviousTransactionHash_asB64()}>
												<td>
													<TxHash
												...
												<td style={{ width: "10rem" }}>
													<Amount amount={i.getAmountIn()} showCurrency />
												</td>
											</tr>
										))}
									</tbody>
						...
						<tr>
							<th scope="row">Outputs ({txInfo.nonChangeOutputs.length})</th>
							<td>
								<Table className="m-0" size="sm">
									<tbody>
										...
										{txInfo.changeOutput && (
											<tr>
												<td>
													<Address address={txInfo.changeOutput.address} /> <small className="text-muted">(change)</small>
												</td>
												<td>
													<Amount amount={txInfo.changeOutput.amount} showCurrency />
												</td>
											</tr>
										)}
