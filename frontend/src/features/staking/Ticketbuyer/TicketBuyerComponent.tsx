...
class Ticketbuyer extends React.Component<Props, InternalState> {
    ...
    componentDidMount() {
        this.setState({
            votingTab: this.determineActiveVotingTab(
                this.props.ticketbuyerRequest
            ),
                            ...
                            <Col sm={4} className="text-center pt-2">
                                {!this.props.loading && (
                                    <div>
                                        ...
                                        <ErrorAlert
                                            error={
                                                this.props.runTicketBuyerError
                                            }
                                        />
                                    </div>
                                )}
