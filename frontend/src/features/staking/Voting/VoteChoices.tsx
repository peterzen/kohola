            ...
            <div>
                <Form className={this.props.inProgress ? "in-progress" : ""}>
                        ...
                        {_.map(agenda.getChoicesList(), (choice) => (
                            ...
                            >
                                <Form.Check
                                    ...
                                    onChange={() =>
                                        this.handleChange(choice.getId())
                                    }
                                    label={choice.getId()}
                                />
                            </ListGroup.Item>
                    ...
                    {this.props.setVoteChoicesResponse != null && (
                        <SuccessAlert
                            message={`Choice set.  Votebits: ${this.props.setVoteChoicesResponse?.getVotebits()}`}
                        />
                    )}
                </Form>
            </div>
...
const mapStateToProps = (state: IApplicationState) => {
    return {
        ...
        inProgress:
            state.staking.voteChoicesAttempting ||
            state.staking.setVoteChoicesAttempting,
        error:
            state.staking.voteChoicesError || state.staking.setVoteChoicesError,
