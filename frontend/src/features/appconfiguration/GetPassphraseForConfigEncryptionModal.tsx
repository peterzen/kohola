...
export class GetPassphraseForConfigEncryptionModal extends React.Component<
    OwnProps,
    InternalState
> {
    ...
    handleFormSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        const verifyPassphrase =
            e.currentTarget.form.elements.verifyPassphrase.value

        if (passphrase != verifyPassphrase) {
            this.setState({
                passphrasesAreNotTheSameErrorMsg:
                    "Your new passphrase is not the same as the verify passphrase",
            })
        } else {
            this.setState({
                passphrasesAreNotTheSameErrorMsg: "",
