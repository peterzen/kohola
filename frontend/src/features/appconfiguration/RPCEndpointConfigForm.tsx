...
export default class RPCEndpointConfigForm extends React.Component<
    IRPCFormProps,
    IRPCFormState
> {
                ...
                <Form.Group className="certificate-input">
                    ...
                    <Form.Control
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                            this.handleCertBlobChange(e.currentTarget.value)
                        }
    ...
    browseFile() {
        ...
        w.walletgui_FileOpenDialog().then((file: string) => {
            this.setState(
                {
                    certFileName: file,
                },
    ...
    handleChange() {
        ...
        if (
            !this.state.formRef.current.checkValidity() ||
...
export class EditEndpointModal extends React.Component<
    GenericModalProps & IRPCFormProps,
    IRPCFormState
> {
    render() {
        return (
