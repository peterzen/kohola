	...
	render() {
		return (
			<Dropdown
				...
				<Dropdown.Toggle id={"trezor-device-options-dropdown"} className="no-arrow mt-3">
...
export default connect(mapStateToProps, mapDispatchToProps)(DeviceOptionsDropdown)
