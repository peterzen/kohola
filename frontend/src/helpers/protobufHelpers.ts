...
function filterList<T extends jspb.Message>(
    list: T[],
    updatedObject: T,
    ...
    return _.filter(
        list,
        (o) =>
            (o.toObject() as any)[identityAttribute] !=
            (updatedObject.toObject() as any)[identityAttribute]
    )
}

// Updates a member of a collection/list of ProtoBuf message objects and returns the mutated list
export function updateObjectInList<T extends jspb.Message>(
    list: T[],
    updatedObject: T,
    identityAttribute: string
): T[] {
...
export function deleteObjectFromList<T extends jspb.Message>(
    list: T[],
    updatedObject: T,
    identityAttribute: string
): T[] {
