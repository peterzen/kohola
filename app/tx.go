...
func _CreateRawTransaction(ctx context.Context, req *walletgui.CreateRawTransactionRequest) (
...
func CreateTransaction(ctx context.Context, req *walletgui.CreateRawTransactionRequest) (
